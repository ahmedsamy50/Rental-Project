<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/RentalMaster.Master" AutoEventWireup="true" CodeBehind="ShowOwner.aspx.cs" Inherits="RentalProject.DataEntry.ShowOwner" %>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <ul class="breadcrumb">
                    ...
                    <li>ِManage Owner(s)</li>
                </ul>
                <h4>Manage Owner(s)</h4>
            </div>
        </div>
        <!-- media -->
    </div>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel panel-default form-bordered">
                ...
                <asp:Repeater ID="RptUsers" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%#Eval("Password")%></td>
                            <td><%#Eval("Exist")%></td>
                            <td><a href='EditOwner.aspx?UserId=<%#Eval("OwnerId")%>' class="btn btn-primary">Update</a></td>
                            <td><a href='#myModal' data-toggle="modal" class="btn btn-primary" onclick="SetId(<%#Eval("OwnerId")%>)">Delete</a></td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
                        </table>
        ...
        <div class="panel-footer">
            <a href='EditOwner.aspx' class="btn btn-primary"><i class="fa fa-user"></i>Add New</a>
        </div>
    </div>
