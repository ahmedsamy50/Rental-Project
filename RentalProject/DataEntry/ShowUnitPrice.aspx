<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/RentalMaster.Master" AutoEventWireup="true" CodeBehind="ShowUnitPrice.aspx.cs" Inherits="RentalProject.DataEntry.ShowUnitPrice" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel panel-default form-bordered">
                ...
                <asp:Repeater ID="RptUsers" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><a href='EditUnitPrice.aspx?UnitPriceId=<%#Eval("UnitPriceId")%>' class="btn btn-primary">Update</a></td>
                            <td><a href='#myModal' data-toggle="modal" class="btn btn-primary" onclick="SetId(<%#Eval("UnitPriceId")%>)">Delete</a></td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
                        </table>
        ...
        <div class="panel-footer">
            <a href='EditUnitPrice.aspx' class="btn btn-primary"><i class="fa fa-user"></i>Add New</a>
        </div>
    </div>
</asp:Content>
