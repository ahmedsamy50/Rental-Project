<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/RentalMaster.Master" AutoEventWireup="true" CodeBehind="ShowCountry.aspx.cs" Inherits="RentalProject.DataEntry.ShowCountry" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainPlaceHolder" runat="server">
            ...
            <asp:Repeater ID="RptUsers" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%#Eval("PhoneCode")%></td>
                        <td><%#Eval("ArabicName")%></td>
                        <td><a href='EditCountry.aspx?CountryId=<%#Eval("CountryId")%>' class="btn btn-primary">Update</a></td>
                        <td><a href='#myModal' data-toggle="modal" class="btn btn-primary" onclick="SetId(<%#Eval("CountryId")%>)">Delete</a></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                    </table>
    ...
    <div class="panel-footer">
        <a href='EditCountry.aspx' class="btn btn-primary"><i class="fa fa-user"></i>Add New</a>
    </div>
              </div>
</asp:Content>
