<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/RentalMaster.Master" AutoEventWireup="true" CodeBehind="ShowDistric.aspx.cs" Inherits="RentalProject.DataEntry.ShowDistric" %>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <ul class="breadcrumb">
                    ...
                    <li>ِManage Distric</li>
                </ul>
                <h4>Manage Distric</h4>
            </div>
        </div>
        <!-- media -->
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel panel-default form-bordered">
        <div class="panel-body">
            <div class="table-responsive ">
                <asp:Repeater ID="RptUsers" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td><%#Eval("DistricId")%></td>
                            <td><%#Eval("EnglishName")%></td>
                            <td><%#Eval("ArabicName")%></td>

                            <td><%#Eval("CityArabicName")%></td>
                            <td><%#Eval("CityEnglishName")%></td>

                            <td><a href='EditDistric.aspx?CitiyId=<%#Eval("DistricId")%>' class="btn btn-primary">Update</a></td>
                            <td><a href='#myModal' data-toggle="modal" class="btn btn-primary" onclick="SetId(<%#Eval("DistricId")%>)">Delete</a></td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
                        </table>
        ...
        <div class="panel-footer">
            <a href='EditDistric.aspx' class="btn btn-primary"><i class="fa fa-user"></i>Add New</a>
        </div>
    </div>
</asp:Content>
