<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/RentalMaster.Master" AutoEventWireup="true" CodeBehind="EditCurrency.aspx.cs" Inherits="RentalProject.DataEntry.EditCurrency" %>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                        ControlToValidate="txtcode" ForeColor="Red" ValidationGroup="Users" SetFocusOnError="true" ErrorMessage="Code Required"></asp:RequiredFieldValidator>
                </div>
