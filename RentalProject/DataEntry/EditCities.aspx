<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/RentalMaster.Master" AutoEventWireup="true" CodeBehind="EditCities.aspx.cs" Inherits="RentalProject.DataEntry.EditCities" %>
        ...
        <div class="panel-body">
            ...
            <div class="col-sm-3">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <asp:DropDownList ID="DDLCountry" CssClass="width300 select" data-placeholder="Choose Nationality" runat="server" required="required"
                            x-moz-errormessage="Select Country"
