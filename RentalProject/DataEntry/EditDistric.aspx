<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/RentalMaster.Master" AutoEventWireup="true" CodeBehind="EditDistric.aspx.cs" Inherits="RentalProject.DataEntry.EditDistric" %>
        ...
        <div class="panel-body">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <br />
                    <div class="col-sm-10">
                        <asp:DropDownList ID="DDLCity" CssClass="width300 select" data-placeholder="Choose City" runat="server" required="required"
                            x-moz-errormessage="Select City"
