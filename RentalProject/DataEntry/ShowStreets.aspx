<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/RentalMaster.Master" AutoEventWireup="true" CodeBehind="ShowStreets.aspx.cs" Inherits="RentalProject.DataEntry.ShowStreets" %>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <ul class="breadcrumb">
                    ...
                    <li>ِManage Streets</li>
                </ul>
                <h4>Manage Streets</h4>
            </div>
        </div>
        <!-- media -->
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel panel-default form-bordered">
                ...
                <asp:Repeater ID="RptUsers" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%#Eval("DistricArabicName")%></td>
                            <td><%#Eval("DistricEnglishName")%></td>

                            <td><a href='EditStreet.aspx?StreetId=<%#Eval("StreetId")%>' class="btn btn-primary">Update</a></td>
                            <td><a href='#myModal' data-toggle="modal" class="btn btn-primary" onclick="SetId(<%#Eval("StreetId")%>)">Delete</a></td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
                        </table>
        ...
        <div class="panel-footer">
            <a href='EditStreet.aspx' class="btn btn-primary"><i class="fa fa-user"></i>Add New</a>
        </div>
    </div>
</asp:Content>
